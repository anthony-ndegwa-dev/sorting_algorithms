...
/**
 * print_bitonic - prints the array modified by bitonic
 * algorithm
 *
 * @arr: input array
 * @i: first index
...
/**
 * recursion - recursive function to execute bitonic sort
 * algorithm
 *
 * @arr: input array
 * @low: first index
...
/**
 * bitonic_sort - first function to execute the bitonic_sort
 * algorithm
 *
 * @array: input array
 * @size: size of the array
